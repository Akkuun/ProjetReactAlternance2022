...
const DeviceDataComponent = ({classes}) => {
    ...
    const getToken = async () => {
        ...
        let installationsListResult = await axios.get("https://visionsystem2-apim-dev.azure-api.net/security/v1/security/getInstallationsByUser/EC9A8BDDBEEE", {
            headers: {
        ...
        <Grid container spacing={3} marginLeft="10%" marginTop="0%">
            <Grid item xs={9}>
                <form>
                    ...
                    <TextField id="outlined-basic" label="A1" variant="outlined" onChange={(e) => setA1(e.target.value)}/>
                </form>
                <List>
                    <div>
