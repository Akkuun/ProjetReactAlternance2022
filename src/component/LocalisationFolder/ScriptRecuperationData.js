...
//Méthode qui prend en paramètre un chemin de répertoire, parcourt tous les fichiers, extrait les coordonnées GPS et si elles sont utilisables
// les insères dans le fichier CSV
function ExtractDataFromCloudBackupToCSV(directory) {
    for (const file of fs.readdirSync(`${directory}/`)) {
        ...
        // qui renvoie un tableau d'éléments après avoir séparé la string de la ,
        if (count < 3) {
